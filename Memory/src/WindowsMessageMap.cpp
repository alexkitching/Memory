...
#define REGISTER_MESSAGE(msg)m_MessageMap.insert({msg, #msg})

WindowsMessageMap* WindowsMessageMap::s_pMessageMap = nullptr;
...
std::string WindowsMessageMap::Read(DWORD msg, LPARAM lp, WPARAM wp)
{
	if (s_pMessageMap == nullptr)
	{
